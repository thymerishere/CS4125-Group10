...
author: "Thomas Bos (), Daniël van Gelder (4551028), Jessie van Schijndel (5407397)"
date: "20/04/2021"
output:
   pdf_document:
      fig_caption: true
...
*Comment by Jessie: Perhaps we could also create groups which do not perform the pre-test to see the influence of this test on the post-test results.*
