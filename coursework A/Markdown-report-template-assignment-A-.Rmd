...
```{r, echo=FALSE, out.width="75%", fig.cap="The conceptual model underlying the research."}
...
```{r, echo=FALSE, out.width="50%", fig.cap="The conceptual model underlying the research."}
...
```{r, warning=FALSE, message=FALSE, out.width="40%", fig.cap="Histogram showing page visits on the website over all factors."}
...
```{r, warning=FALSE, message=FALSE, out.width="50%", fig.cap="Bar plot showing the mean page visits per independent variable."}
...
```{r, warning=FALSE, message=FALSE, fig.cap="Poisson distribution (lambda = 1.5) fitted to data of page visits"}
p <- web_visit %>% 
  ggplot( aes(x=pages)) + 
...
```{r, warning=FALSE, message=FALSE, out.width="75%", fig.cap="WAIC comparison between Bayesian models capturing effects of different variables."}
