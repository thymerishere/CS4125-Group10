function Task4()
    ...
    X = mnist_data(:,I).';
    Y = mnist_labels(I,:);
    calculate_and_plot(X,Y, "Dimension reduction using t-SNE on the MNIST dataset", "Dimension reduction using Multi Dimensional Scaling on the MNIST dataset.")
    X = meas;
    Y = species;
    calculate_and_plot(X,Y, "Dimension reduction using t-SNE on the Fisher Iris dataset", "Dimension reduction using Multi Dimensional Scaling on the Fisher Iris dataset.")
